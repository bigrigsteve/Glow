...
import { calculateAverageCycleLength, getPhaseInfo, calculateCyclePredictions } from '@/lib/cycle-calculations'
import { Card, CardBody } from '@/components/ui/Card'
import { TrendingUp, Activity, Heart, Lightbulb } from 'lucide-react'
...
interface InsightsData {
  cycles: { cycleLength: number | null; startDate: string }[]
  logs: { symptoms: string[]; mood: string | null; flow: string | null }[]
  profile: { averageCycleLength: number; averagePeriodLength: number; lastPeriodStart: string | null } | null
}
...
export default function InsightsPage() {
  ...
  const { cycles = [], logs = [], profile } = data ?? {}
